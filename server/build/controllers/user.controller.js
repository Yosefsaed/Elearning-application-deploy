...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const html = await ejs_1.default.renderFile(path_1.default.join(__dirname, "../mails/activation-mail.ejs"), //*
        data);
        try {
            ...
            return next(new ErrorHandler_1.default(error.massage, 400));
        }
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.massage, 400));
