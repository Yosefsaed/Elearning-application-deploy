                                ...
                                data.benefits?.map((item: any, index: number) => (
                                    <div className="w-full flex 800px:items-center py-2" key={index}>
                                        <div className="w-[15px] mr-1">
                                            <IoCheckmarkOutline size={20} className="text-black dark:text-white" />
                                        </div>
                    ...
                    <div className="w-full 800px:w-[35%] relative">
                        ...
                        {/* <div className="flex item-center">
                            <h1 className="flex items-center">
                                {data.price === 0 ? "Free" : data.price + "E£"}
                            </h1>
                        </div> */}
                        <div className="flex items-center">
                            {
                        ...
                        <p className="pb-1 dark:text-white text-black">. 3D model</p>
            ...
            <>
                {
                    open && (
                        <div className="w-full h-screen bg-[#00000036] fixed top-0 left-0 z-50 flex items-center justify-center">
                            <div className="w-[500px] min-h-[500px] bg-white rounded-xl sha p-3">
